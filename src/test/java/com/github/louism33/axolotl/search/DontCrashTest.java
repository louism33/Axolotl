...
//                System.out.println(uciEntry.board);
//                System.out.println("***");
//                System.out.println("age is " + EngineBetter.age);
//                System.out.println("***");
...
//                System.out.println("PV is " + genericMoves);
                String s = MoveParser.toString(EngineBetter.getAiMove());
//                System.out.println("ai move " + s);
//                System.out.println("appending " + genericMoves.get(0) + " and " + genericMoves.get(1));
                mmm += genericMoves.get(0) + " " + genericMoves.get(1) + " ";
//                System.out.println("*************");
//                System.out.println("aged out is " + TranspositionTable.agedOut);
