...
public class MateMTTest {
    ...
    public static void finalSuccessTally() {
        System.out.println("\nSuccessful Mate sanity tests: " + successes + " out of " + checkmatePositions.length
                + " with " + threads + " threads. Anything above " + targetSuccesses + " can be thought of as ok.");
    ...
    public MateMTTest(Object edp, Object name) {
