...
import static com.github.louism33.axolotl.old.MoveOrderer.updateKillerMoves;
import static com.github.louism33.axolotl.old.MoveOrderer.updateMateKillerMoves;
...
//                    && PVLine.verifyMove(hashMove, moves)
        ...
        com.github.louism33.axolotl.old.MoveOrderer.scoreMoves(whichThread, moves, board, ply, hashMove);
        ...
        if (ply == 0 && hashMove != 0){
            Assert.assertEquals(moves[0] & com.github.louism33.axolotl.old.MoveOrderer.MOVE_MASK, hashMove);
        }
        for (int i = 0; i < moves.length; i++) {
            ...
            int move = moves[i] & com.github.louism33.axolotl.old.MoveOrderer.MOVE_MASK;

            boolean captureMove = MoveParser.isCaptureMove(move);
            boolean promotionMove = MoveParser.isPromotionMove(move);
            boolean givesCheckMove = com.github.louism33.axolotl.old.MoveOrderer.checkingMove(board, move);
            ...
            if (score > bestScore) {
                bestScore = score;
                bestMove = move & com.github.louism33.axolotl.old.MoveOrderer.MOVE_MASK;
            ...
            if (alpha >= beta) {
                ...
                com.github.louism33.axolotl.old.MoveOrderer.updateHistoryMoves(whichThread, move, ply);
                break;
            }
        }
        ...
        addToTableReplaceByDepth(board.zobristHash,
                bestMove & com.github.louism33.axolotl.old.MoveOrderer.MOVE_MASK, bestScore, depth, flag, ply);
