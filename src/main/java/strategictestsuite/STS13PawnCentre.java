...
public class STS13PawnCentre {
    ...
    public static void finalSuccessTally() {
        System.out.println("STS13PawnCentre: Successes: " + successes + " out of " + splitUpPositions.length);
        System.out.println();
    }
...
List<Object[]> answers = new ArrayList<>();
    ...
    public STS13PawnCentre(Object edp, Object name) {
