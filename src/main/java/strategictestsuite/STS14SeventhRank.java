...
public class STS14SeventhRank {
    ...
    public static void finalSuccessTally() {
        System.out.println("STS14SeventhRank: Successes: " + successes + " out of " + splitUpPositions.length);
        System.out.println();
    }
...
List<Object[]> answers = new ArrayList<>();
    ...
    public STS14SeventhRank(Object edp, Object name) {
