...
public class EloTest {
    ...
    public void testElo() {
        ...
        int elo2 = 1000;
        String move2 = search("2nq1nk1/5p1p/4p1pQ/pb1pP1NP/1p1P2P1/1P4N1/P4PB1/6K1 w");
        ...
        int elo3 = 1000;
        String move3 = search("8/3r2p1/pp1Bp1p1/1kP5/1n2K3/6R1/1P3P2/8 w");
        ...
        int elo4 = 1000;
        String move4 = search("8/4kb1p/2p3pP/1pP1P1P1/1P3K2/1B6/8/8 w");
        ...
        int elo5 = 1000;
        String move5 = search("b1R2nk1/5ppp/1p3n2/5N2/1b2p3/1P2BP2/q3BQPP/6K1 w");
        ...
        int elo6 = 1000;
        String move6 = search("3rr1k1/pp3pbp/2bp1np1/q3p1B1/2B1P3/2N4P/PPPQ1PP1/3RR1K1 w");
        ...
        int elo8 = 1000;
        String move8 = search("2R1r3/5k2/pBP1n2p/6p1/8/5P1P/2P3P1/7K w");
        ...
        int elo9 = 1000;
        String move9 = search("2r2rk1/1p1R1pp1/p3p2p/8/4B3/3QB1P1/q1P3KP/8 w");
        ...
        Assert.assertTrue(elo > 2000);
    }

    private String search(String fen) {
        Chessboard board = new Chessboard(fen);
        System.out.println(board);
        SearchSpecs.basicTimeSearch(60_000 * 5);
