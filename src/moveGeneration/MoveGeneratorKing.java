...
public class MoveGeneratorKing {
    ...
    public static List<Move> masterMoveKing(Chessboard board, boolean white, long legalPushes, long legalCaptures){
        long ans = 0, king;
    ...
    public static List<Move> masterKingCaptures(Chessboard board, boolean white, long legalCaptures){
    ...
    public static List<Move> masterKingPushes(Chessboard board, boolean white, long legalPushes){
        long ans = 0, knights, king;
        List<Move> moves = new ArrayList<>();
        if (white){
            knights = board.WHITE_KNIGHTS;
